...
export function PlatformBadge({ platform }: { platform: StreamingLink }) {
  return (
    <a
      ...
      className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-base-800 px-4 py-3.5 transition-colors hover:border-ember-500/50 hover:bg-base-700"
    >
      <span className="font-medium">{platform.serviceName}</span>
